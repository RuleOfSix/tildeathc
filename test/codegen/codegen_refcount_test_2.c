...
int main(void) {
	struct il_node input = {.type=IL_ROOT_NODE, .val.str=NULL, .id=0, .lineno=0, .num_children=5, .children=(struct il_node[]) {
								...
								{.type=IL_OP_NODE, .val.op=IL_BIF_OP, .id=3, .lineno=2, .num_children=3, .children=(struct il_node[]) {
									...
									{.type=IL_DEC_NODE, .val.str="LEFT", .id=5, .lineno=2, .num_children=0, .children=NULL},
								...
								{.type=IL_OP_NODE, .val.op=IL_IF_OP, .id=9, .lineno=4, .num_children=2, .children=(struct il_node[]) {
									{.type=IL_VAR_NODE, .val.str="LEFT", .id=10, .lineno=4, .num_children=0, .children=NULL},
									{.type=IL_OP_NODE, .val.op=IL_BLOCK_OP, .id=11, .lineno=4, .num_children=3, .children=(struct il_node[]) {
										{.type=IL_OP_NODE, .val.op=IL_DIE_OP, .id=12, .lineno=5, .num_children=1, .children=(struct il_node[]) {
											{.type=IL_VAR_NODE, .val.str="LEFT", .id=13, .lineno=5, .num_children=0, .children=NULL}}},
										{.type=IL_OP_NODE, .val.op=IL_IF_OP, .id=14, .lineno=6, .num_children=2, .children=(struct il_node[]) {
											{.type=IL_VAR_NODE, .val.str="LEFT", .id=15, .lineno=6, .num_children=0, .children=NULL},
											{.type=IL_OP_NODE, .val.op=IL_JMP_OP, .id=16, .lineno=6, .num_children=1, .children=(struct il_node[]) {
												{.type=IL_TAR_NODE, .val.tar=11, .id=17, .lineno=6, .num_children=0, .children=NULL}}}}},
										{.type=IL_OP_NODE, .val.op=IL_OUT_OP, .id=18, .lineno=6, .num_children=1, .children=(struct il_node[]) {
											{.type=IL_STR_NODE, .val.str="Left not freed", .id=19, .lineno=6, .num_children=0, .children=NULL}}}}}}},
	...
	codegen_test(&input, "Left not freed", false);
}
