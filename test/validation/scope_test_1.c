...
int main(void) {
	struct il_node input =  {.type=IL_ROOT_NODE, .val.str=NULL, .id=0, .lineno=0, .num_children=4, .children=(struct il_node[]) {
								...
								{.type=IL_OP_NODE, .val.op=IL_IF_OP, .id=3, .lineno=3, .num_children=2, .children=(struct il_node[]) {
									...
									{.type=IL_OP_NODE, .val.op=IL_BLOCK_OP, .id=5, .lineno=3, .num_children=3, .children=(struct il_node[]) {
								...
								{.type=IL_OP_NODE, .val.op=IL_DIE_OP, .id=14, .lineno=8, .num_children=1, .children=(struct il_node[]) {
									{.type=IL_VAR_NODE, .val.str="BUTTERFLY", .id=15, .lineno=8, .num_children=0, .children=NULL}}},
								{.type=IL_OP_NODE, .val.op=IL_DIE_OP, .id=16, .lineno=10, .num_children=1, .children=(struct il_node[]) {
									{.type=IL_VAR_NODE, .val.str="THIS", .id=17, .lineno=10, .num_children=0, .children=NULL}}}}};
